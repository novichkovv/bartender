                ...
                <form class="form-horizontal" method="post">
                    <div class="form-group">
                        <div class="col-md-10 col-md-offset-1">
                            <label for="inputEmail1" class="control-label">Пользователь</label>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-1 col-lg-10">
                            <div class="checkbox">
                                ...
                                <span class="styled-checkbox-label">Запомнить</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="text-center">
                            <button type="submit" name="login_btn" class="btn btn-danger btn-lg">Войти</button>
                        </div>
                    </div>
                </form>
            </div>
